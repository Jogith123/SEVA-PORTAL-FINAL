...
export default function Header({ user, admin, userType, language, setLanguage }: HeaderProps) {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold">{t.portalTitle}</h1>
                <p className="text-sm opacity-80">{t.governmentOfIndia}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <select 
              ...
              className="bg-white/10 text-white border-white/20 rounded-md px-3 py-1 text-sm cursor-pointer hover:bg-white/20 outline-none"
            >
